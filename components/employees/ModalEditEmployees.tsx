...
import { updateEmployee, UpdateEmployeeDto } from "@/services/api/employees";
...
const ModalEditEmployees: React.FC<ModalEditEmployeeProps> = ({
  id,
  data,
  openDialogEdit,
  onOpenChange,
    ...
    if (data) {
      setForm({
        ...
        hire_date: data.hire_date
          ? new Date(data.hire_date).toISOString().slice(0, 10)
          : "",
        imageFile: undefined,
      });
    }
  ...
  return (
    <Dialog open={openDialogEdit} onOpenChange={onOpenChange}>
      <DialogContent>
        <AlertDialogHeader>
...
export default ModalEditEmployees;
