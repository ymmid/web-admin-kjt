...
export async function generateInvoiceExcel(form: InvoiceFormData) {
  ...
  // Grand Total
  worksheet.getCell(`J30`).value = "Grand Total";
  worksheet.getCell("K30").value = { formula: "SUM(K28:K29)" };
  ...
  worksheet.getCell("J30").font = { bold: true };
  worksheet.getCell("K30").font = { bold: true };
